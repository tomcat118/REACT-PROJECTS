...
//         {/* fetch the coverart as an image and crops to desirable size to fit in customed round shape */}
//         <img 
//           alt = "art"
...
//         />
//         {/* get the subtitle of  each songData objectv that includes info about artistId */}
//         <div className ="ml-5">
//           <p className = "font-bold sm:text-3x text-xl text-white">{artistId ? artist?.name : songData?.title}</p>
//           {!artistId && (
